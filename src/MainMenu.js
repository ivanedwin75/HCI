...
TABGAME.MainMenu.prototype = {
	create: function() {
		...
		this.startButton = this.add.button(TABGAME._WIDTH*0.5, 170, 'button-start', this.startGame, this, 2, 0, 1);
		this.startButton.anchor.set(0.5,0);
		this.startButton.input.useHandCursor = true;
		this.menuButton = this.add.button(TABGAME._WIDTH*0.5, 250, 'button-menu', this.MenuOpcion, this, 2, 0, 1);
